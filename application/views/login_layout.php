    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                ?>
                <form autocomplete="off" action="<?php echo base_url(); ?>User/doLogin" method="post" class="form-horizontal">
                    <div class="well col-lg-12">
                        <fieldset>
                            ...
                            <a href="<?php echo base_url(); ?>User/forgotPassword">¿Olvido su contraseña?</a>
                        </fieldset>
                    </div>
